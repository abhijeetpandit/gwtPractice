...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "hello_gwt" because\n';
  ...
  $wnd.__gwt_activeModules['hello_gwt'] = {
    'moduleName' : 'hello_gwt',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/hello_gwt.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['hello_gwt'].superdevmode = true;

  var expectedSuffix = '/hello_gwt.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + hello_gwt + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:hello_gwt';
  var devModeSessionKey = '__gwtDevModeSession:hello_gwt';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/hello_gwt/hello_gwt.nocache.js';
  ...
  $wnd.__gwt_activeModules['hello_gwt'].canRedirect = true;
  $wnd.__gwt_activeModules['hello_gwt'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/hello_gwt?user.agent=' + ua + '&_callback=' + callback;
